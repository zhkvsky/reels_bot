# reels_bot
Telegram-бот для генерации уникальных идей коротких видео (Reels / TikTok / Shorts).
# Стек
...
- В действительности, вы можете просто заменить промпт в prompts.py на свой собственный, и использовать бота по своему назначению.
